...
export class DataController {
    ...
    public static async create(@Body('record') record: any): Promise<MethodResult> {
        const repo = (this as any).methodus.repository;
    ...
    public static async update(@Param('id') id: string, @Body('record') record: any): Promise<MethodResult> {
        const repo = (this as any).methodus.repository;
    ...
    public static async delete(@Param('id') id: string): Promise<MethodResult> {
        const repo = (this as any).methodus.repository;
    ...
    public static async query(@Body('query') queryObject: any): Promise<MethodResult> {
        const repo = (this as any).methodus.repository;
